...
export const CARDS = [
  ...
  { id: "targeted_wrong_name_day", type: "targeted", title: "WRONG NAME DAY",
    body: "For ~30 minutes, everyone calls [TARGET] by [WRONG_NAME]. Robin assigns the new name. Never acknowledge corrections.",
    image: "cards/targeted_wrong_name_day.png", weight: 1, tapCount: 3, placeholders: ["TARGET", "WRONG_NAME"] },
